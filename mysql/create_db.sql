...
CREATE TABLE IF NOT EXISTS loan (
	...
	amount DOUBLE PRECISION NOT NULL,
	rate DOUBLE PRECISION NOT NULL DEFAULT 0.1,
...
DELIMITER $
CREATE TRIGGER guaranteed_by_dueDate_default
	BEFORE INSERT ON guaranteed_by FOR EACH ROW
	SET_DEF: BEGIN
 		SET NEW.dueDate=ADDDATE(CURDATE(), 365);
	END SET_DEF $
DELIMITER ;
